        ...
        <div className="prose prose-slate dark:prose-invert max-w-none space-y-6 text-[15px] leading-relaxed">
          ...
          {[
            ...
            },
            {
              ...
              a: "In the Code of Federal Regulations Title 42, Part 493. The relevant subsections are §493.927 (general immunology), §493.931 (general chemistry), §493.933 (endocrinology), §493.937 (toxicology), and §493.941 (hematology). Search for 'acceptable performance' within each section to find the specific criteria."
            },
          ].map(({ q, a }) => (
