...
const plans = [
  ...
  { priceType: "clinic",          name: "Clinic",                 price: "$499",   unit: "per year",  description: "0-25 beds. Solo director or designee and one tech.",                                                                      features: ["2 seats included", "Full VeritaAssure™ suite, all modules", "VeritaMap™ regulatory mapping", "VeritaScan™ self-inspection audit", "VeritaComp™ competency management", "CLIA number on all reports"],                                                                                                 cta: "Subscribe",      highlight: false, badge: null },
  { priceType: "community",       name: "Community",              price: "$799",   unit: "per year",  description: "26-100 beds. Full suite for community hospital labs.",                                                                    features: ["5 seats included", "Full VeritaAssure™ suite, all modules", "VeritaStaff™ personnel management", "CLIA number on all reports", "Complimentary 1-hour onboarding session via Zoom or Teams with a VeritaAssure™ specialist"],                                                                   cta: "Subscribe",      highlight: true,  badge: "Most Popular" },
  { priceType: "hospital",        name: "Hospital",               price: "$1,299", unit: "per year",  description: "101-300 beds. Full suite for regional and acute care hospital labs.",                                                     features: ["15 seats included", "Everything in Community", "Priority support", "Complimentary 1-hour onboarding session via Zoom or Teams with a VeritaAssure™ specialist"],                                                                                                                             cta: "Subscribe",      highlight: false, badge: null },
  { priceType: "enterprise",      name: "Enterprise",             price: "$1,999", unit: "per year",  description: "300+ beds. Multi-department or health system. Up to 25 seats.",                                                          features: ["25 seats included", "Everything in Hospital", "Priority support", "Consulting access", "BAA available", "Complimentary 1-hour onboarding session via Zoom or Teams with a VeritaAssure™ specialist"],                                                                                       cta: "Subscribe",      highlight: false, badge: null },
];
