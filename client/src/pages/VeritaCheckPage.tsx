...
const plans = [
  ...
  { priceType: "veritacheck_only", name: "VeritaCheck\u2122 Unlimited", price: "$299",   unit: "per year",  description: "Single user. Method validation suite only. CLIA number required at checkout.",                                                    features: ["Unlimited studies", "All VeritaCheck study types", "Full PDF reports", "Study history dashboard"],                                                                                                    cta: "Subscribe",      highlight: false, badge: null },
