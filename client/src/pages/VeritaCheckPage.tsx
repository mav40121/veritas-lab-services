...
const plans = [
  ...
  { priceType: "community",       name: "Community",              price: "$799",   unit: "per year",  description: "Community hospitals and independent labs.",                                                                              features: ["5 seats included", "Full VeritaAssure™ suite, all modules", "VeritaStaff™ personnel management", "CLIA number on all reports", "Complimentary 1-hour onboarding session via Zoom or Teams with a VeritaAssure™ specialist"],                                                                   cta: "Subscribe",      highlight: true,  badge: "Most Popular" },
  { priceType: "hospital",        name: "Hospital",               price: "$1,299", unit: "per year",  description: "Regional and acute care hospital labs.",                                                                                 features: ["15 seats included", "Everything in Community", "Priority support", "Complimentary 1-hour onboarding session via Zoom or Teams with a VeritaAssure™ specialist"],                                                                                                                             cta: "Subscribe",      highlight: false, badge: null },
  { priceType: "enterprise",      name: "Enterprise",             price: "$1,999", unit: "per year",  description: "Large hospitals, health systems, and reference labs.",                                                                   features: ["25 seats included", "Everything in Hospital", "Priority support", "Consulting access", "Complimentary 1-hour onboarding session via Zoom or Teams with a VeritaAssure™ specialist"],                                                                                                          cta: "Subscribe",      highlight: false, badge: null },
];
