...
function renderVeritaAssureContent(): string {
  return `<h2>VeritaAssure&#8482; laboratory compliance platform</h2><p>VeritaAssure&#8482; is the integrated compliance platform for clinical laboratories from Veritas Lab Services, LLC, built by a former Joint Commission laboratory surveyor with more than 200 facility inspections. It unites performance verification, inspection readiness, test menu mapping, competency assessment, policy control, personnel records, and certificate monitoring in one browser-based system. No desktop software, no installation, and no protected health information is stored.</p><p>The suite is eighteen modules in two streams. Twelve compliance modules: VeritaCheck&#8482; runs the performance verification studies required under 42 CFR Part 493 (Calibration Verification / Linearity, Correlation / Method Comparison, precision, and reagent and QC lot verification) and generates CFR-cited PDF reports with a laboratory director or designee signature block on page 1. VeritaMap&#8482; maps every instrument and analyte to its CLIA complexity, specialty, and FDA classification. VeritaScan&#8482; scores self-inspection readiness across 173 compliance items in 10 domains against the current TJC standard and the CAP checklist. VeritaComp&#8482; manages competency using all six CLIA assessment elements on the Initial, 6-month, and annual timeline. VeritaPolicy&#8482; pre-loads the policies CLIA requires and crosswalks each one to your accreditor. VeritaStaff&#8482; holds the personnel roster with CLIA role assignments and auto-generates the CMS 209 Laboratory Personnel Report. VeritaLab&#8482; tracks CLIA, CAP, TJC, COLA, and state certificates with advance expiration reminders. VeritaPT&#8482; checks the test menu against CLIA proficiency testing requirements and surfaces gaps. VeritaTrack&#8482; is the regulatory compliance calendar. VeritaQC&#8482; evaluates daily quality control against Westgard multi-rules. VeritaResponse&#8482; turns a survey citation into a tracked finding with a per-accreditor due-date clock and renders a plan of correction. VeritaMaintain&#8482; logs instrument maintenance and function checks against a schedule and flags what is overdue.</p><p>Six operations modules extend the platform: VeritaBench&#8482;, VeritaPace&#8482;, VeritaShift&#8482;, VeritaQA&#8482;, VeritaStock&#8482;, and VeritaOps&#8482;. Modules share data, so the test menu in VeritaMap&#8482; feeds VeritaCheck&#8482; instrument selection, VeritaComp&#8482; competency assignment, and VeritaPT&#8482; enrollment checks. VeritaAssure&#8482; states the regulatory result; final approval and clinical determination rest with the laboratory director or designee.</p>`;
}
function renderOperationsContent(): string {
  return `<h2>VeritaAssure&#8482; laboratory operations</h2><p>The operations stream of the VeritaAssure&#8482; platform covers laboratory productivity, staffing, quality metrics, inventory, and cost per reportable test. Six modules, built by a former Joint Commission laboratory surveyor with more than 200 facility inspections, browser-based, with no protected health information stored.</p><p>VeritaBench&#8482; is a free one-page benchmarking tool with no sign-in: it checks whether your laboratory's billable tests per paid hour fall inside, above, or below the published benchmark. VeritaPace&#8482; tracks productivity month over month with billable tests, paid hours, FTE, overtime, and trend lines, built for managers reporting operational performance to the C-suite. VeritaShift&#8482; analyzes workload hour by hour for shift design and FTE planning, showing where staffed capacity matches demand and where the gaps are. VeritaQA&#8482; is a performance improvement dashboard for department-level quality indicators, tracking metric trends, targets, and corrective actions. VeritaStock&#8482; handles reagent and supply inventory with lot tracking, expiration alerts, calculated par levels, FIFO rotation prompts, and burn-rate-based reorder triggers. VeritaOps&#8482; is a layered cost-per-reportable-test calculator: reagents and supplies plus staff time, with capital depreciation and overhead as opt-in layers, built on CLSI GP11-A cost accounting principles to answer the build versus buy and charge-master questions with transparent math the laboratory director or designee can defend.</p><p>The operations modules complement the twelve compliance modules of VeritaAssure&#8482;, which cover performance verification, inspection readiness, test menu mapping, competency, policy, personnel, certificates, proficiency testing, the regulatory calendar, daily quality control, post-survey deficiency response, and equipment maintenance. Eighteen modules in total.</p>`;
}
// Batch 7 (2026-07-17): the two pages that sell the consultant rather than the
// software. Every product page was made crawlable in batches 3 and 4 while
// /services and /team sat at ~530 and ~478 chars, which meant the site's whole
// consulting proposition, and the credential the resource articles trade on, was
// invisible to the crawler that sent the reader. Copy is each page's own content
// (ServicesPage.tsx and TeamPage.tsx), not restated from memory.
function renderServicesContent(): string {
  return `<h2>Laboratory consulting services</h2><p>Veritas Lab Services provides laboratory consulting delivered by Michael Veri, MS, MBA, MLS(ASCP), CPHQ, a former Joint Commission surveyor with more than 200 facility inspections. Three service lines: regulatory readiness and mock inspections, productivity and workflow optimization, and leadership coaching and education.</p><p><strong>Regulatory readiness and mock inspections.</strong> Structured regulatory reviews and mock inspections that mirror real survey conditions, so your team identifies and corrects issues before they become findings. On-site inspection readiness is an expert-led walkthrough emulating real regulatory inspections across CLIA, TJC, CAP, COLA, and FDA, with a detailed review of policies, procedures, and quality documentation, hands-on staff education and direct troubleshooting, workflow and regulatory compliance review, and a post-survey written report with findings and recommendations.</p><p><strong>Productivity and workflow optimization.</strong> On-site assessments that connect operational performance with regulatory expectations, helping you optimize staffing, processes, and turnaround times without compromising compliance. Includes industry-standard benchmarking of staffing and workflows, identification of inefficiencies arising from staffing gaps, outdated processes, or resource misallocation, customized analysis reports with clear and actionable recommendations, and C-suite communication support with data-driven staffing rationales.</p><p><strong>Leadership coaching and education.</strong> Coaching for laboratory leaders and frontline staff on how to think like surveyors, communicate with administration, and build a culture where compliance is sustainable rather than reactive. Single one-hour sessions or blocks of ten, with topics entirely chosen by you: C-suite relationship building and communication, laboratory leadership career development, and mentorship for directors and managers who are the most senior in their organizations. Interactive online sessions cover a full spectrum of laboratory and hospital topics tailored to specific educational needs, including blood administration co-owned across laboratory, nursing, and providers, QC and QA review and implementation, and an introduction to the laboratory survey process for nursing.</p>`;
}
function renderTeamContent(): string {
  return `<h2>Michael Veri, MS, MBA, MLS(ASCP), CPHQ</h2><p>Veritas Lab Services, LLC is led by Michael Veri, a laboratory operations consultant and the founder of the VeritaAssure&#8482; compliance software suite. He served as a Joint Commission surveyor for four years and has conducted more than 200 facility inspections, and he is the author of Lab Management 101: A Guide to Laboratory Leadership, forthcoming.</p><p>Credentials: MS, Master of Science in Chemistry. MBA, Master of Business Administration. MLS(ASCP), Medical Laboratory Scientist. CPHQ, Certified Professional in Healthcare Quality. Former Joint Commission surveyor, four years. Founder of the VeritaAssure&#8482; compliance software suite.</p><p>Published work and speaking topics include co-owning blood administration among laboratory, nursing, and providers; laboratory leadership's view of accreditation; forming a blood utilization and management program; and capturing productivity in the laboratory. The same surveyor perspective behind that work is what VeritaAssure&#8482; automates and what the laboratory consulting engagements deliver on site.</p>`;
}
...
function injectSeoTags(html: string, routePath: string, meta: SEOMetadata): string {
  ...
  if (routePath === "/resources/clia-tea-lookup") {
  ...
  } else if (routePath === "/veritadc" || routePath === "/veritapolicy") {
    ...
    noscriptInner += renderServicesContent();
  } else if (routePath === "/team") {
    noscriptInner += renderTeamContent();
  }
